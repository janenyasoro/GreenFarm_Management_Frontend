...
const fields = [
  ...
  { name: "category", label: "Category", type: "select", options: ["seeds", "fertilizer", "feed", "tools", "equipment", "other"], required: false },
  { name: "quantity", label: "Quantity", type: "number", required: false },
  { name: "unit", label: "Unit", type: "select", options: ["kg", "g", "liters", "pieces", "bags", "bottles"], required: false },
